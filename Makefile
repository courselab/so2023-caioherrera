...
hw-hex.bin : hw.hex
	./tools/hex2bin hw.hex hw-hex.bin

hw-s.bin : hw.S
	as --32 hw.S -o hw.o
	ld -melf_i386 --oformat=binary -e begin -Ttext=0x7c00 hw.o -o hw-s.bin

hw-c.bin : hw.c hw.ld hw_rt0.c hw_utils.c
...
## Manually adding this rule to make my life easier
